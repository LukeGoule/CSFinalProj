...
// All of these values have `val / 255.f` because I am much more comfortable working with 8bit RGBA over float colours.
...
struct Colours_t
{
	...
	ImVec4 EvenLighter	= ImVec4(50.f / 255.f, 50.f / 255.f, 50.f / 255.f, 1.f);
