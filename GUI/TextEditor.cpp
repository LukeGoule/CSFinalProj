...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::AQA_ASM()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		...
		langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("#[0-9]+", PaletteIndex::Number)); // Number
		langDef.mTokenRegexStrings.push_back(std::make_pair<std::string, PaletteIndex>("[r|R][0-9][0-1]*", PaletteIndex::Keyword)); // Registers

		langDef.mCommentStart = ";";
		langDef.mCommentEnd = ";";
		langDef.mSingleLineComment = ";";
		langDef.mCaseSensitive = false;
		langDef.mName = "AQA ASM";
